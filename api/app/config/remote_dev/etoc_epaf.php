...
return array(
   ...
   // 'debug' => false,
    'debug' => true,
    'environment_name' => 'remote_dev [medi-stage]',
   ...
   // 'cc' => 'cdmprinceton@gmail.com',
    ...
    'paf_fax_disposition' => 'https://synagis-paf-dev.med.cdm210.com/api/post_epaf_fax_disposition',

    //CWC servlet endpoint
    'cwc_url' => 'https://stage.cradlewithcare.com/etoc_epaf/Registration?action=register',
    // 'cwc_url' => 'https://cradle.ngrok.com/servlet/Registration?action=register',
