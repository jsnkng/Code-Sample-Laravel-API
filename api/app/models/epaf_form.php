...
class EPAFForm
{
    ...
    *******************************************************************************/
    public function __construct($ip="unavailable")
    {
        ...
        $this->validatorError = '';
        $this->error = '';
        $this->application_type = 'epaf';

        Log::info("########################");
        Log::info("EPAFForm->__construct");
    }
    ...
    public function create($array)
    {
        ...
        $this->instance($array);
        $epaf_validator = new EPAFValidator();
        $epaf_validator->validate($this->_data);
        $this->valid = $epaf_validator->valid;
        $this->validator = $epaf_validator->validator;
        $this->validatorError = $epaf_validator->validatorError;
        Log::info("EPAFForm->create()");
    }
    ...
    public function update_application_messagestatus($statustype_id, $return_id, $status)
    {
        ...
        Log::info("EPAFForm->update_application_messagestatus '".$statustype_id."','".$return_id."','','".$status."'");
    ...
    public function instance($array)
    {
        ...
        $this->_data['patient_firstname'] = isset($array['patient_firstname']) ? ucwords(strtolower(substr($array['patient_firstname'], 0, 15))) : '';
        $this->_data['patient_lastname'] = isset($array['patient_lastname']) ? ucwords(strtolower(substr($array['patient_lastname'], 0, 15))) : '';
        $this->_data['patient_middlename'] = isset($array['patient_middlename']) ? ucwords(strtolower(substr($array['patient_middlename'], 0, 15))) : '';
        $this->_data['patient_birthdate'] = isset($array['patient_birthdate']) ? substr($array['patient_birthdate'], 0, 10) : '';
        ...
        $this->_data['patient_dischargedate'] = isset($array['patient_dischargedate']) ? substr($array['patient_dischargedate'], 0, 20) : '';
        $this->_data['patient_number'] = isset($array['patient_number']) ? substr($array['patient_number'], 0, 18) : '';
        $this->_data['caregiver_firstname'] = isset($array['caregiver_firstname']) ? ucwords(strtolower(substr($array['caregiver_firstname'], 0, 15))) : '';
        $this->_data['caregiver_lastname'] = isset($array['caregiver_lastname']) ? ucwords(strtolower(substr($array['caregiver_lastname'], 0, 15))) : '';
        ...
        $this->_data['hospital_contact_firstname'] = isset($array['hospital_contact_firstname']) ? ucwords(strtolower(substr($array['hospital_contact_firstname'], 0, 20))) : '';
        $this->_data['hospital_contact_lastname'] = isset($array['hospital_contact_lastname']) ? ucwords(strtolower(substr($array['hospital_contact_lastname'], 0, 20))) : '';
        ...
        $this->_data['pediatrician_practice'] = isset($array['pediatrician_practice']) ? ucwords(strtolower(substr($array['pediatrician_practice'], 0, 20))) : '';
        ...
        $this->_data['pediatrician_suite'] = isset($array['pediatrician_suite']) ? substr($array['pediatrician_suite'], 0, 10) : '';
        $this->_data['pediatrician_city'] = isset($array['pediatrician_city']) ? ucwords(strtolower(substr($array['pediatrician_city'], 0, 20))) : '';
        $this->_data['pediatrician_state'] = isset($array['pediatrician_state']) ? substr($array['pediatrician_state'], 0, 10) : '';
        $this->_data['pediatrician_zip'] = isset($array['pediatrician_zip']) ? substr($array['pediatrician_zip'], 0, 10) : '';
        $this->_data['diagnosis_premature'] = isset($array['diagnosis_premature']) ? substr($array['diagnosis_premature'], 0, 10) : '';
        $this->_data['diagnosis_bpdcldp'] = isset($array['diagnosis_bpdcldp']) ? substr($array['diagnosis_bpdcldp'] , 0, 10): '';
        $this->_data['diagnosis_other'] = isset($array['diagnosis_other']) ? substr($array['diagnosis_other'], 0, 10) : '';
        $this->_data['diagnosis_chd'] = isset($array['diagnosis_chd']) ? substr($array['diagnosis_chd'], 0, 10) : '';
        ...
        $this->_data['dosing_date'] = isset($array['dosing_date']) ? substr($array['dosing_date'], 0, 10) : '';
        $this->_data['dosing_datenext'] = isset($array['dosing_datenext']) ? substr($array['dosing_datenext'], 0, 10) : '';
        ...
        Log::info("EPAFForm->instance()");
    }

    public function get_representative()
    {
        $representative = DB::select("CALL get_representative('".$this->_data['pediatrician_zip']."');");

        if(!isset($representative[0]->id)) {
             $this->_data['rep_id'] = '0';

            Log::info("EPAFForm->get_representative() [FAIL] return representative_id: 0");
            return;
        }
        ...
        Log::info("EPAFForm->get_representative() [SUCCESS] return representative_id: ".$this->_data['rep_id'] );
            return;
    ...
    public function insert_pediatrician()
    {
        ...
        Log::info("EPAFForm->insert_pediatrician() [SUCCESS] return pediatrician_id: ".$pediatrician[0]->pediatrician_id);
    ...
    public function insert_application()
    {
        ...
        $application = DB::select("CALL insert_application(
            ...
            '".addslashes($this->ip)."');");
        Log::info("EPAFForm->insert_application() [SUCCESS] return application_id ".$application[0]->application_id);
        ...
        $errormessage)
    {
        $application_messagestatus = DB::select("CALL insert_application_messagestatus(
            ...
            '".$errorcode."',
            '".$errormessage."');");
        Log::info("EPAFForm->insert_application_messagestatus() [SUCCESS] return application_messagestatus_id ".$application_messagestatus[0]->application_messagestatus_id);
    ...
    public function insert_application_optin($application_id, $optintype_id)
    {
       $application_optin_id = DB::select("CALL insert_application_optin(
            '".$application_id."',
            '".$optintype_id."');");
        Log::info("EPAFForm->insert_application_optin() [SUCCESS] return application_optin_id ".$application_optin_id[0]->application_optin_id);
